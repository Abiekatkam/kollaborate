...
const InitialServerModal = () => {
  ...
  return (
    <Dialog open>
      <DialogContent className="sm:max-w-md p-0 border-2 dark:border-neutral-700 selection:bg-green-100 selection:text-green-600 dark:selection:bg-green-600 dark:selection:text-green-100 border-neutral-400">
