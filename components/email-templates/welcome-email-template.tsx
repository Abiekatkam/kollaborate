...
export default function WelcomeEmail() {
  return (
    <Html>
      <Tailwind>
        <Head />
        <Preview>Welcome to {APP_CONFIGURATION.APPLICATION_NAME} </Preview>
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
            ...
            <Heading className="text-black text-[24px] font-normal text-center p-0 mb-[24px] mt-[22px] mx-0">
              Welcome to {APP_CONFIGURATION.APPLICATION_NAME} ✨
            </Heading>
            <Text className="text-black text-[14px] leading-[24px]">
              Hello, I'm <strong>{APP_CONFIGURATION.DEVELOPER_NAME}</strong>,
              the developer behind{" "}
              <strong>{APP_CONFIGURATION.APPLICATION_NAME}</strong>, a
              collaborative platform designed to enhance teamwork and project
              management. We're thrilled to welcome you aboard!
            </Text>
            <Text className="text-black text-[14px] leading-[24px]">
            ...
            <Text className="m-1">
              2. Follow us on <br />
              <Link
                href={CLIENT_SIDE_URL.SOCIAL_LINKS.TWITTER_PROFILE}
                target="_blank"
                className="underline"
              >
                Twitter
              ...
              <br />
              <Link
                href={CLIENT_SIDE_URL.SOCIAL_LINKS.LINKEDIN_PROFILE}
                target="_blank"
                className="underline"
              >
                Linkedin
              ...
              <br />
              <Link
                href={CLIENT_SIDE_URL.SOCIAL_LINKS.GITHUB_PROFILE}
                target="_blank"
                className="underline"
              >
                Github
